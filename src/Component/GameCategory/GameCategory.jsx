...
import allStyle from './GameCategory.module.css'
export default function GameCategory() {
  let{cat}= useParams()
  console.log(cat);
  const [gamesCategory, setgamesCategory] = useState(null)
  ...
  return (
    ...
    {gamesCategory?gamesCategory.slice(0,slice).map((game,idx)=>  <div key={idx}className="col-lg-3 col-md-6">
